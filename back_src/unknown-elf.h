/* Definitions for non-Linux based Unicore64 systems using ELF
...
/* The __USES_INITFINI__ define is tested in newlib/libc/sys/unicore64/crt0.S
...
#define SUBTARGET_CPU_DEFAULT 		TARGET_CPU_unicore1
#endif
